...
export default function DownToRightWalker() {
    ...
    const sketch = (p5: p5) => {
        ...
        class Walker {
            ...
            step() {
                // Move either left or down randomly
                if (p5.random() < 0.5) {
                    this.x -= 1; // Move left
                } else {
                    this.y += 1; // Move down
    ...
    return (
        <SketchLayout
            title="Exercise 0.1: Down to Right Walker"
            description="A random walk that has a greater tendency to move down to the right"
        >
