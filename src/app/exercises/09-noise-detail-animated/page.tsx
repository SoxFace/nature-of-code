...
export default function NoiseDetailAnimated() {
        ...
        p5.draw = () => {
            ...
            for (let x = 0; x < p5.width; x++) {
                ...
                for (let y = 0; y < p5.height; y++) {
                    ...
                    const bright = p5.map(p5.noise(xoff, yoff, speed), 0, 1, 0, 255);
                    //Calculating hue value for noise
                    const hu = p5.map(p5.noise(xoff, yoff, speed), 0, 1, 0, 360);
    ...
    return (
        <SketchLayout
            title="Exercise 0.9: Noise Detail"
